...
const SignupSchema = Yup.object().shape({
  ...
  password: Yup.string().min(8, 'Password must contain 8 or more characters!').required('Required'),
});
      ...
      >
        {({ handleSubmit, errors, touched }) => (
          <Form className={s.loginForm}>
            ...
            <p className={s.formText}>Or log in using an email and password, after registering:</p>
